...
const logsDirectory = resolve(home, "Library/Logs/teams-user-scripts");
const domain = `gui/${uid}`;
const debugArguments = "--remote-debugging-port=9223";

const agents = [
  {
    label: "com.guyfaux.teams-userscript-env",
...
<dict>
  <key>Label</key>
  <string>com.guyfaux.teams-userscript-env</string>
...
`,
  ...
  {
    label: "com.guyfaux.teams-userscript-loader",
    plist: `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN"
  "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
  <key>Label</key>
  <string>com.guyfaux.teams-userscript-loader</string>
  <key>ProgramArguments</key>
  <array>
    <string>${escapeXml(process.execPath)}</string>
    <string>${escapeXml(resolve(repository, "teams-userscript-loader.mjs"))}</string>
    <string>--port</string>
    <string>9223</string>
    <string>--scripts</string>
    <string>${escapeXml(resolve(repository, "userscripts"))}</string>
  </array>
